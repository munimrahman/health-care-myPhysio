        ...
        <div>
            <div className="row mx-3 d-flex align-items-center">
                <div className="col-12 col-md-6">
                    <h1>user name</h1>
                    <h1 className="text-info fw-bold text-center">Sign Up</h1>
                    <div className="w-50 mx-auto">
                        ...
                        <div className="text-center mt-4">
                            <button onClick={handleSignUp} className="btn btn-info shadow-none text-white fw-bold rounded-pill">Sign Up</button>
                        </div>
                    </div>
