    ...
    return (
        <footer>
            <div className="footer-main pt-3">
                <div className="mx-5 row py-3">
                    <div className="col-12 col-md-3 d-flex justify-content-center align-items-center py-3">
                        <i class="fab fa-facebook-square fs-2 px-3 footer-icn-font"></i>
                        <i class="fab fa-twitter-square fs-2 px-3 footer-icn-font"></i>
                        <i class="fab fa-linkedin fs-2 px-3 footer-icn-font"></i>
                        <i class="fab fa-youtube fs-2 px-3 footer-icn-font"></i>

                    </div>
                    <div className="col-12 col-md-3 d-flex align-items-center py-3">
                        <i class="fas fa-map-marker-alt footer-icn-font"></i>
                        <div className="px-4">
                    ...
                    <div className="col-12 col-md-3 d-flex align-items-center py-3">
                        <i class="fas fa-phone-alt footer-icn-font"></i>
                        <div className="px-4">
                    ...
                    <div className="col-12 col-md-3 d-flex align-items-center py-3">
                        <i class="fas fa-envelope footer-icn-font"></i>
                        <div className="px-4">
                    ...
                    <div className="py-2 col-12 col-md-3">
                        ...
                        <table class="table w-75">
                            <tbody>
                                ...
                                <tr>
                                    <td>Sunday</td>
                                    <td className="text-end"><span class="badge bg-dark">CLOSED</span></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div className="bg-dark py-3 text-color-gray text-center">
                <a className="text-color-gray p-3" href="">Privacy</a>
                <a className="text-color-gray p-3" href="">Terms</a>
                <a className="text-color-gray p-3" href="">Sitemap</a>
                <br />
