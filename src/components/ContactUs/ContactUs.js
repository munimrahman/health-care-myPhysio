    ...
    return (
        <div>
            <div className="text-white section-header bg-linear text-center mb-5">
                <h1 className="fw-bold pt-5 font-size-custom">Contsct Us</h1>
                <h6 className="pb-5">Home &gt; Contact Us</h6>
            </div>
            <div className="w-75 row mx-auto my-5 d-flex align-items-center">
                {/* contact info section */}
                <div className="col-12 col-md-4">
                    <div className="d-flex align-items-center">
                        <div className="bg-info icn-bg d-flex align-items-center justify-content-center">
                ...
                <div className="col-12 col-md-8 border-start border-info">
                    <div className="ms-3">
                        ...
                        <div>
                            ...
                            <button className="btn btn-info rounded-pill fw-bold text-white shadow-none">Submit</button>
                        </div>
                    </div>
                </div>
            </div>
